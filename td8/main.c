...
// On suppose ici qu'un identificateur est simplement une suite de lettres et que sa
...
int main(void) {
    ...
    /* Affichage de la table triee avant les idents ayant un nombre pair de lettres */
    printf("----------\n");
